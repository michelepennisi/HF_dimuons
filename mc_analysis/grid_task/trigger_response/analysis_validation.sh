...
if ! [ -f HF_TriggeResponse_294813.root ] ; then
   error=1
   echo "Output file HF_TriggeResponse_294813.root not found. Job FAILED !" >> stdout
   echo "Output file HF_TriggeResponse_294813.root not found. Job FAILED !" >> stderr
fi
