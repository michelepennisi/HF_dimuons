...
if ! [ -f HF_MCDimuHFTree_294009.root ] ; then
   error=1
   echo "Output file HF_MCDimuHFTree_294009.root not found. Job FAILED !"
   echo "Output file HF_MCDimuHFTree_294009.root not found. Job FAILED !" >> stderr
fi
