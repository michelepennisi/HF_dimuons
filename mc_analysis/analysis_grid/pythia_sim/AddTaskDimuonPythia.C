AliAnalysisTaskDimuonPythia *AddTaskDimuonPythia(TString MC_type, Int_t RunNumber = 294009)
{
   ...
   if (!mgr)
   {
      ::Error("AddTaskDimuonPythia", "No analysis manager to connect to.");
      return NULL;
   }
   TString fnameout;
   ...
   AliAnalysisTaskDimuonPythia *MCQuarkoniumTask = new AliAnalysisTaskDimuonPythia("AliAnalysisTaskDimuHFTreeMC");
