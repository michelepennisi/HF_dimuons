...
def main():
    ...
    ds_bb_dy_PYTHIA_fwd = np.array([22.4, 22.4])
    stat_ds_bb_dy_PYTHIA_fwd = np.array([1.0, 1.0])
    syst_ds_bb_dy_PYTHIA_fwd = np.array([8.26, 8.26])
    ...
    dev_Arr_min_ds_dy_bb_FONLL_NNPDF = (Arr_ds_dy_bb_FONLL_NNPDF-Arr_min_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_max_ds_dy_bb_FONLL_NNPDF = (Arr_max_ds_dy_bb_FONLL_NNPDF-Arr_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_min_sc_ds_dy_bb_FONLL_NNPDF = (Arr_ds_dy_bb_FONLL_NNPDF-Arr_min_sc_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_max_sc_ds_dy_bb_FONLL_NNPDF = (Arr_max_sc_ds_dy_bb_FONLL_NNPDF-Arr_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_min_mass_ds_dy_bb_FONLL_NNPDF = (Arr_ds_dy_bb_FONLL_NNPDF-Arr_min_mass_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_max_mass_ds_dy_bb_FONLL_NNPDF = (Arr_max_mass_ds_dy_bb_FONLL_NNPDF-Arr_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_min_pdf_ds_dy_bb_FONLL_NNPDF = (Arr_ds_dy_bb_FONLL_NNPDF-Arr_min_pdf_ds_dy_bb_FONLL_NNPDF)
    dev_Arr_max_pdf_ds_dy_bb_FONLL_NNPDF = (Arr_max_pdf_ds_dy_bb_FONLL_NNPDF-Arr_ds_dy_bb_FONLL_NNPDF)

    print(dev_Arr_min_ds_dy_bb_FONLL_NNPDF[(1)])
    # ds_dy_bb_FONLL_NNPDF*1e-06
    ...
    dev_Arr_min_ds_dy_bb_FONLL_CTEQ6 = (Arr_ds_dy_bb_FONLL_CTEQ6-Arr_min_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_max_ds_dy_bb_FONLL_CTEQ6 = (Arr_max_ds_dy_bb_FONLL_CTEQ6-Arr_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_min_sc_ds_dy_bb_FONLL_CTEQ6 = (Arr_ds_dy_bb_FONLL_CTEQ6-Arr_min_sc_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_max_sc_ds_dy_bb_FONLL_CTEQ6 = (Arr_max_sc_ds_dy_bb_FONLL_CTEQ6-Arr_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_min_mass_ds_dy_bb_FONLL_CTEQ6 = (Arr_ds_dy_bb_FONLL_CTEQ6-Arr_min_mass_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_max_mass_ds_dy_bb_FONLL_CTEQ6 = (Arr_max_mass_ds_dy_bb_FONLL_CTEQ6-Arr_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_min_pdf_ds_dy_bb_FONLL_CTEQ6 = (Arr_ds_dy_bb_FONLL_CTEQ6-Arr_min_pdf_ds_dy_bb_FONLL_CTEQ6)
    dev_Arr_max_pdf_ds_dy_bb_FONLL_CTEQ6 = (Arr_max_pdf_ds_dy_bb_FONLL_CTEQ6-Arr_ds_dy_bb_FONLL_CTEQ6)
    ...
    FONLL_bb_cs_NNPDF_minmaxerror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_NNPDF, Arr_ds_dy_bb_FONLL_NNPDF, Arr_low_ey_FONLL_NNPDF,
                                                           Arr_up_ey_FONLL_NNPDF, dev_Arr_min_ds_dy_bb_FONLL_NNPDF, dev_Arr_max_ds_dy_bb_FONLL_NNPDF)
    FONLL_bb_cs_NNPDF_minmaxerror.SetName("FONLL_bb_cs_NNPDF_minmaxerror")
    FONLL_bb_cs_NNPDF_minmaxerror.SetLineWidth(2)
    FONLL_bb_cs_NNPDF_minmaxerror.SetLineColorAlpha(ROOT.kGray, 0.9)
    ...
    FONLL_bb_cs_NNPDF_scalerror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_NNPDF, Arr_ds_dy_bb_FONLL_NNPDF, Arr_low_ey_FONLL_NNPDF,
                                                         Arr_up_ey_FONLL_NNPDF, dev_Arr_min_sc_ds_dy_bb_FONLL_NNPDF, dev_Arr_max_sc_ds_dy_bb_FONLL_NNPDF)
    FONLL_bb_cs_NNPDF_scalerror.SetName("FONLL_bb_cs_NNPDF_scalerror")
    FONLL_bb_cs_NNPDF_scalerror.SetLineColorAlpha(ROOT.kCyan-10, 0.9)
    FONLL_bb_cs_NNPDF_scalerror.SetFillColorAlpha(ROOT.kCyan-10, 0.4)
    ...
    FONLL_bb_cs_NNPDF_masserror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_NNPDF, Arr_ds_dy_bb_FONLL_NNPDF, Arr_low_ey_FONLL_NNPDF,
                                                         Arr_up_ey_FONLL_NNPDF, dev_Arr_min_mass_ds_dy_bb_FONLL_NNPDF, dev_Arr_max_mass_ds_dy_bb_FONLL_NNPDF)
    FONLL_bb_cs_NNPDF_masserror.SetName("FONLL_bb_cs_NNPDF_masserror")
    FONLL_bb_cs_NNPDF_masserror.SetMarkerStyle(20)
    FONLL_bb_cs_NNPDF_masserror.SetLineColorAlpha(ROOT.kGreen, 0.9)
    ...
    FONLL_bb_cs_NNPDF_pdferror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_NNPDF, Arr_ds_dy_bb_FONLL_NNPDF, Arr_low_ey_FONLL_NNPDF,
                                                         Arr_up_ey_FONLL_NNPDF, dev_Arr_min_pdf_ds_dy_bb_FONLL_NNPDF, dev_Arr_max_pdf_ds_dy_bb_FONLL_NNPDF)
    FONLL_bb_cs_NNPDF_pdferror.SetName("FONLL_bb_cs_NNPDF_pdferror")
    FONLL_bb_cs_NNPDF_pdferror.SetMarkerStyle(20)
    FONLL_bb_cs_NNPDF_pdferror.SetLineColorAlpha(ROOT.kMagenta-9, 0.9)
    FONLL_bb_cs_NNPDF_pdferror.SetFillColorAlpha(ROOT.kMagenta-9, 0.4)
    ...
    Legend_bb_cs_NNPDF_FONLL = ROOT.TLegend(0.175, 0.18, 0.475, 0.525, " ", "brNDC")
    Legend_bb_cs_NNPDF_FONLL.SetHeader("       #it{FONLL}")
    Legend_bb_cs_NNPDF_FONLL.AddEntry(FONLL_bb_cs_NNPDF_minmaxerror, "unc. tot.", "F")
    Legend_bb_cs_NNPDF_FONLL.AddEntry(FONLL_bb_cs_NNPDF_scalerror, "unc. scale", "F")
    Legend_bb_cs_NNPDF_FONLL.AddEntry(FONLL_bb_cs_NNPDF_masserror, "unc. mass", "F")
    Legend_bb_cs_NNPDF_FONLL.AddEntry(FONLL_bb_cs_NNPDF_pdferror, "unc. pdf", "F")
    ...
    Legend_bb_cs_NNPDF_Meas = ROOT.TLegend(0.475, 0.18, 0.725, 0.525, " ", "brNDC")
    ...
    FONLL_bb_cs_CTEQ6_minmaxerror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_CTEQ6, Arr_ds_dy_bb_FONLL_CTEQ6, Arr_low_ey_FONLL_CTEQ6,
                                                           Arr_up_ey_FONLL_CTEQ6, dev_Arr_min_ds_dy_bb_FONLL_CTEQ6, dev_Arr_max_ds_dy_bb_FONLL_CTEQ6)
    FONLL_bb_cs_CTEQ6_minmaxerror.SetName("FONLL_bb_cs_CTEQ6_minmaxerror")
    FONLL_bb_cs_CTEQ6_minmaxerror.SetLineWidth(2)
    FONLL_bb_cs_CTEQ6_minmaxerror.SetLineColorAlpha(ROOT.kGray, 0.9)
    ...
    FONLL_bb_cs_CTEQ6_scalerror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_CTEQ6, Arr_ds_dy_bb_FONLL_CTEQ6, Arr_low_ey_FONLL_CTEQ6,
                                                         Arr_up_ey_FONLL_CTEQ6, dev_Arr_min_sc_ds_dy_bb_FONLL_CTEQ6, dev_Arr_max_sc_ds_dy_bb_FONLL_CTEQ6)
    FONLL_bb_cs_CTEQ6_scalerror.SetName("FONLL_bb_cs_CTEQ6_scalerror")
    FONLL_bb_cs_CTEQ6_scalerror.SetLineColorAlpha(ROOT.kCyan-10, 0.9)
    FONLL_bb_cs_CTEQ6_scalerror.SetFillColorAlpha(ROOT.kCyan-10, 0.4)
    ...
    FONLL_bb_cs_CTEQ6_masserror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_CTEQ6, Arr_ds_dy_bb_FONLL_CTEQ6, Arr_low_ey_FONLL_CTEQ6,
                                                         Arr_up_ey_FONLL_CTEQ6, dev_Arr_min_mass_ds_dy_bb_FONLL_CTEQ6, dev_Arr_max_mass_ds_dy_bb_FONLL_CTEQ6)
    FONLL_bb_cs_CTEQ6_masserror.SetName("FONLL_bb_cs_CTEQ6_masserror")
    FONLL_bb_cs_CTEQ6_masserror.SetMarkerStyle(20)
    FONLL_bb_cs_CTEQ6_masserror.SetLineColorAlpha(ROOT.kGreen, 0.9)
    ...
    FONLL_bb_cs_CTEQ6_pdferror = ROOT.TGraphAsymmErrors(17, Arr_y_FONLL_CTEQ6, Arr_ds_dy_bb_FONLL_CTEQ6, Arr_low_ey_FONLL_CTEQ6,
                                                         Arr_up_ey_FONLL_CTEQ6, dev_Arr_min_pdf_ds_dy_bb_FONLL_CTEQ6, dev_Arr_max_pdf_ds_dy_bb_FONLL_CTEQ6)
    FONLL_bb_cs_CTEQ6_pdferror.SetName("FONLL_bb_cs_CTEQ6_pdferror")
    FONLL_bb_cs_CTEQ6_pdferror.SetMarkerStyle(20)
    FONLL_bb_cs_CTEQ6_pdferror.SetLineColorAlpha(ROOT.kMagenta-9, 0.9)
    FONLL_bb_cs_CTEQ6_pdferror.SetFillColorAlpha(ROOT.kMagenta-9, 0.4)
    ...
    Legend_bb_cs_CTEQ6_FONLL = ROOT.TLegend(0.175, 0.18, 0.475, 0.525, " ", "brNDC")
    Legend_bb_cs_CTEQ6_FONLL.SetHeader("       #it{FONLL}")
    Legend_bb_cs_CTEQ6_FONLL.AddEntry(FONLL_bb_cs_CTEQ6_minmaxerror, "unc. tot.", "F")
    Legend_bb_cs_CTEQ6_FONLL.AddEntry(FONLL_bb_cs_CTEQ6_scalerror, "unc. scale", "F")
    Legend_bb_cs_CTEQ6_FONLL.AddEntry(FONLL_bb_cs_CTEQ6_masserror, "unc. mass", "F")
    Legend_bb_cs_CTEQ6_FONLL.AddEntry(FONLL_bb_cs_CTEQ6_pdferror, "unc. pdf", "F")
    
    Legend_bb_cs_CTEQ6_FONLL.SetBorderSize(0)
    Legend_bb_cs_CTEQ6_FONLL.SetFillColor(10)
    Legend_bb_cs_CTEQ6_FONLL.SetFillStyle(1)
    Legend_bb_cs_CTEQ6_FONLL.SetLineStyle(0)
    Legend_bb_cs_CTEQ6_FONLL.SetLineColor(0)
    Legend_bb_cs_CTEQ6_FONLL.SetTextFont(42)
    Legend_bb_cs_CTEQ6_FONLL.SetTextSize(0.04)
    Legend_bb_cs_CTEQ6_FONLL.Draw()

    Legend_bb_cs_CTEQ6_Meas = ROOT.TLegend(0.475, 0.18, 0.725, 0.525, " ", "brNDC")
    Legend_bb_cs_CTEQ6_Meas.AddEntry(bb_cs_PYTHIA_fwd, "(#it{m}_{#mu^{#plus}#mu^{#minus}}, #it{p}_{T, #mu^{#plus}#mu^{#minus}}) PYTHIA8 fit", "P")
    Legend_bb_cs_CTEQ6_Meas.AddEntry(bb_cs_PYTHIA_mid, "#splitline{(#it{m}_{e^{#plus}e^{#minus}}, #it{p}_{T, e^{#plus}e^{#minus}}) PYTHIA6 fit}{Phys. Lett. B788 (2019) 505}", "P")
    Legend_bb_cs_CTEQ6_Meas.SetBorderSize(0)
    Legend_bb_cs_CTEQ6_Meas.SetFillColor(10)
    Legend_bb_cs_CTEQ6_Meas.SetFillStyle(1)
    Legend_bb_cs_CTEQ6_Meas.SetLineStyle(0)
    Legend_bb_cs_CTEQ6_Meas.SetLineColor(0)
    Legend_bb_cs_CTEQ6_Meas.SetTextFont(42)
    Legend_bb_cs_CTEQ6_Meas.SetTextSize(0.035)
    Legend_bb_cs_CTEQ6_Meas.Draw()
