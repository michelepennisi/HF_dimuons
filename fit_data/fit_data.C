...
void cross_section()
{
    ...
    NameMC_file[2] = TString::Format("%s/mc_analysis_output/LHC18p_DY/Version_2_AliAOD/LHC18p_DY_MC_output_Tree_merged.root", info.path_to_file.Data());
